...
{
    public class TimeXUnitTests_Ex4
    {
        [Theory]
        [InlineData(-1, 59, 59)]
        [InlineData(24, 59, 59)]
        ...
        [InlineData(12, 59, -1)]
        [InlineData(12, 59, 60)]
        public void CreateTime_InvalidValues_ExceptionOccurs(int h, int m, int s)
        {
        ...
        [Theory]
        [InlineData(-1, 59, 59, "Invalid hour: -1")]
        [InlineData(24, 59, 59, "Invalid hour: 24")]
        [InlineData(12, -1, 59, "Invalid minute: -1")]
        [InlineData(12, 60, 59, "Invalid minute: 60")]
        [InlineData(12, 59, -1, "Invalid second: -1")]
        [InlineData(12, 59, 60, "Invalid second: 60")]
        public void CreateTime_InvalidValues_ExceptionOccursWithMessage(int h, int m, int s, string message)
        {
            try
            {
                Time t = new Time(h, m, s);
